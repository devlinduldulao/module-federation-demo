...
const AnalyticsSkeleton = memo(() => (
    <div role="status" className="w-full mx-auto animate-pulse">
        ...
        <div className="border border-edge p-4 sm:p-5 mb-8">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                <div>
                    <div className="h-2.5 w-20 bg-muted mb-2" />
                    <div className="h-5 w-32 bg-elevated" />
                </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4 mb-8">
            {Array.from({ length: 4 }).map((_, i) => (
                <div key={i} className="border border-edge p-4 sm:p-5 min-h-[96px]">
                    <div className="h-2.5 w-24 bg-muted mb-3" />
                    <div className="flex items-end justify-between">
                        <div className="h-7 w-16 bg-elevated" />
        ...
        <div className="border border-edge p-4 sm:p-5">
            <div className="h-2.5 w-24 bg-muted mb-3" />
            {Array.from({ length: 6 }).map((_, i) => (
                <div key={i} className="flex items-start gap-3 py-3.5 border-b border-edge last:border-0">
