...
const AnalyticsSkeleton = memo(() => (
    <div role="status" className="w-full mx-auto animate-pulse">
        ...
        <div className="mb-8 lg:mb-10 border-b border-border pb-6">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                <div className="max-w-2xl">
                    <div className="h-2.5 w-28 bg-muted mb-2 rounded-md" />
        ...
        <div className="border border-border p-4 sm:p-5 mb-8 rounded-lg">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                <div>
                    <div className="h-2.5 w-20 bg-muted mb-2 rounded-md" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4 mb-8">
            {Array.from({ length: 4 }).map((_, i) => (
                <div key={i} className="border border-border p-4 sm:p-5 min-h-[96px] rounded-lg">
                    <div className="h-2.5 w-24 bg-muted mb-3 rounded-md" />
        ...
        <div className="border border-border p-4 sm:p-5 rounded-lg">
            <div className="h-2.5 w-24 bg-muted mb-3 rounded-md" />
            {Array.from({ length: 6 }).map((_, i) => (
                <div key={i} className="flex items-start gap-3 py-3.5 border-b border-border last:border-0">
                    <div className="w-5 h-3 bg-muted rounded-md" />
                    <div className="flex-1">
                        <div className="h-3 w-full max-w-md bg-muted mb-1.5 rounded-md" />
                        <div className="h-2.5 w-14 bg-muted rounded-md" />
                    </div>
                </div>
            ))}
